...
namespace ProjectResume.Controllers
{
    public class WorkExperiencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Employer,EmploymentDate,JobDuties")] WorkExperience workExperience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Employer,EmploymentDate,JobDuties")] WorkExperience workExperience)
        {
