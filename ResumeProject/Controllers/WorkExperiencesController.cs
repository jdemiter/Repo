...
namespace ResumeProject.Controllers
{
    public class WorkExperiencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Employer,EmploymentDates,JobDuties,JobTitle")] WorkExperience workExperience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Employer,EmploymentDates,JobDuties,JobTitle")] WorkExperience workExperience)
        {
